...
class Plateau:
    ...
    def est_gagnant(self, position_pion):
        ...
        pion = li_li_cases[y_pos][x_pos]
        color = pion.get_color()
        
        return (color == "b" and y_pos == 0) or (color == "n" and y_pos == 2)


    def deplace(self, position_pion, action : str):
        ...
        if pion.get_color() == "b":
            if action == "A":
                li_li_cases[y_pos-1][x_pos] = pion
    
            else:
                if action == "G":
                    li_li_cases[y_pos-1][x_pos-1] = pion
